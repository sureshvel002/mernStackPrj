...
const mongodb = "mongodb+srv://sureshvdm02:sureshvdm@cluster0.hiamz3a.mongodb.net/NewYear?retryWrites=true&w=majority";
app.get('/', (req, res) => {
...
//deploy server
// mongoose.connect(process.env.mongodb, { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false}).then(() => {
//     app.listen(5000,console.log(`server is running on port ${PORT}`))}).catch(err => console.log(err))
